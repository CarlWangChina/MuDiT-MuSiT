...
In December 2022, we [released an improved large model named `large-v2`](https://github.com/ama-prof-divi/whisper/discussions/661), and `large-v3` in November 2023.
