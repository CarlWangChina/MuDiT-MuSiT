...
if __name__ == '__main__':
    ...
    for i in trange(1, 401):
        src2 = data[str(i)]["song_name"][0:-4] #100395_src
        path = '/home/zhehui/FAD/MusicGenCN/' + src2 + '_generated' + '.wav'
    ...
    with open("/home/zhehui/wangqi/clapresult_MusicGenCN.csv","w",encoding="utf-8") as f:
        writer = csv.writer(f)
        for i in range(400):
