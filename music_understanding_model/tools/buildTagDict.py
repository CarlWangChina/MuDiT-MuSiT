import os
import json
from Code_for_Experiment.Metrics.music_understanding_model.ans.QuestionEncoder import EncoderGroup
...
if __name__ == "__main__":
    enc = EncoderGroup(data=load_file("../datas/s0_ans_compress.jsonl", 10))
    enc.save_to_file("../datas/s0_ans_dict.txt")
    encode_file("../datas/s0_ans_compress.jsonl", "../datas/s0_ans_token.txt", enc)
    print("s0 dict len:", enc.kwsum)
    enc = EncoderGroup(data=load_file("../datas/s1_ans_compress.jsonl", 10))
    enc.save_to_file("../datas/s1_ans_dict.txt")
    encode_file("../datas/s1_ans_compress.jsonl", "../datas/s1_ans_token.txt", enc)
