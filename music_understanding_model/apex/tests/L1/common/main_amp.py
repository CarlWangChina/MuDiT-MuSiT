...
model_names = sorted(name for name in make_models.__dict__
                     if name.islower() and not name.startswith("__")
                     and callable(make_models.__dict__[name]))
...
def main():
    ...
    if args.pretrained:
        ...
        model = make_models.__dict__[args.arch](pretrained=True)
    else:
        print("=> creating model '{}'".format(args.arch))
        model = make_models.__dict__[args.arch]()
