...
if True:
    ...
    print("using jit")
    from Code_for_MuChin_AP.backend_api.gunicorn_cfg import load
...
bn_result = compare("comparing biased variance: ", var_biased, b_v, error) and sbn_result
...
bn_result = compare("comparing weight grad: ", grad_weight, grad_weight_r, error) and sbn_result
bn_result = compare("comparing mean_dy grad: ", mean_dy, mean_dy_r, error) and sbn_result
bn_result = compare("comparing mean_dy_xmu grad: ", mean_dy_xmu, mean_dy_xmu_r, error) and sbn_result
bn_result = compare("comparing input grad: ", grad_input, grad_input_r, error) and sbn_result
...
bn_result = compare("comparing running_variance: ", bn.running_var.data, sbn.running_var.data, error) and sbn_result
