import torch
import importlib
importlib.import_module("Code_for_Experiment.Metrics.music_understanding_model.apex.apex.amp.rnn._compat")
from typing import Optional
import torch.nn as nn

class LabelEmbedding(nn.Module):
    def __init__(self, num_classes: int, hidden_dim: int, *, dropout: float = 0.0, device: Optional[torch.device] = None):
