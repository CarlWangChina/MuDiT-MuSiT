...
class SEANetBaseModule(nn.Module, ABC):
    """Base module of SEANet encoder / decoder.
    Args:
        num_channels (int):                 Number of input channels.
        latent_dim (int):                   The dimension of the latent space.
        num_initial_filters (int):          Number of initial filters.  Defaults to 32.
        ...
        activation (str):                   The activation function type.  Defaults to "LeakyReLU".
        activation_params (Dict[str, Any]): The activation function parameters.
        final_activation (str):             The activation function of the final layer.  Defaults to "Tanh".
        norm (str):                         The normalization method of the block. Defaults to "BatchNorm1d".
        norm_params (Dict[str, Any]):       The parameters of the normalization method.
        padding_mode (str):                 The padding mode of the block. Defaults to "reflect".
        dropout (float):                    The dropout rate.  Defaults to 0.0.
    """
    def __init__(self,
                 num_channels: int,
                 latent_dim: int,
                 num_initial_filters: int = 32,
...
class SEANetEncoder(SEANetBaseModule):
    """The encoder of SEANet.
    Args:
        num_channels (int):                 Number of input channels.
        latent_dim (int):                   The dimension of the latent space.
        num_initial_filters (int):          Number of initial filters.
        upsampling_ratios (List[int]):      The upsampling ratios of the encoder.
        upsampling_kernel_sizes (List[int]): The kernel sizes of the upsampling layers.
        resblock_kernel_sizes (List[int]):  The kernel sizes of the residual blocks.
        resblock_dilation_sizes (List[List[int]]): The dilation sizes of the residual blocks.
        initial_kernel_size (int):          The kernel size of the initial layer.  Defaults to 7.
        last_kernel_size (int):             The kernel size of the last layer.  Defaults to 7.
