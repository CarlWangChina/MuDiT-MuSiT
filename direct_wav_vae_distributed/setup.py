...
setup(
    name="ama-prof-divi-vae2",
    version=__VERSION__,
    author=__AUTHOR__,
    url="https://github.com/ama-prof-divi-ai/ama-prof-divi-vae2",
    description="The refactored VAE module to work with waveforms without MEL spectrogram.",
