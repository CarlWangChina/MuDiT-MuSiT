...
from Code_for_Experiment.Targeted_Training.data_prep_demucs.demucs.states import _check_diffq
...
def add_model_flags(parser):
    ...
    group.add_argument("-n", "--name", default="htdemucs", help="Pretrained model name or signature. Default is htdemucs.")
...
def get_model_from_args(args):
    ...
    print(bold("Important: the default model was recently changed to `htdemucs`"), "the latest Hybrid Transformer Demucs model. In some cases, this model can ", "actually perform worse than previous models. To get back the old default model ", "use `-n mdx_extra_q`.")
