...
from Code_for_Experiment.Targeted_Training.data_prep_demucs.demucs.svd import svd_penalty
...
class Solver(object):
    ...
    def _reset(self):
        if self.checkpoint_file.exists():
            ...
            package = torch.load(self.checkpoint_file, map_location='cpu')
            ...
            package = torch.load(cf, map_location='cpu')
            self.best_state = package['best_state']
