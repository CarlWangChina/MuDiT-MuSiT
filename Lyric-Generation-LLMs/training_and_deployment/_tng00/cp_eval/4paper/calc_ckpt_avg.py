...
jf_paths = glob(f'{root_dir}ckpt2001_cb/*/**/pid_*_all.json', recursive=True)
...
with open(f'{root_dir}ckpt2001_cb_scores.json', 'w', encoding='utf-8') as f:
...
with open(f'{root_dir}ckpt2001_cb_d_avgs.json', 'w', encoding='utf-8') as f:
