...
from music_dit.modules.diffusion import DDIMSampler, DiT, TrainingLoss, Diffusion

logger = get_logger(__name__)

class TestDiffusion(unittest.TestCase):
    def setUp(self):
        self.device = torch.device(get_hparams().device)
    ...
    def test_ddim_timesteps(self):
        ...
        for spacing in ["linspace", "leading", "trailing"]:
            ...
            self.assertEqual(ddim_sampler.inference_timesteps.device, self.device)
